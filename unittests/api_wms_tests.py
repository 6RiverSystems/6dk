...
class ApiWmsTests(sixDKTests):
    ...
    def testAcknowledgementSuccessResponse(self):
        """test WMS acknowledgement API success response for receiving an acknowledgement
    ...
    def testAcknowledgementSuccessDatabase(self):
        """test WMS acknowledgement API success database update for receiving an acknowledgement
    ...
    def testAcknowledgementUnknownTokenResponse(self):
        """test WMS acknowledgement API unknown token response for receiving an acknowledgement
    ...
    def testContainerAcceptedSuccessResponse(self):
        """test WMS container-accepted API success response for receiving an container-accepted
    ...
    def testContainerAcceptedSuccessDatabase(self):
        """test WMS container-accepted API success database update for receiving an container-accepted
    ...
    @vcr.use_cassette('cassettes/container-accepted-success-proxy-response.yml')
    ...
    @vcr.use_cassette('cassettes/container-accepted-success-proxy-database.yml')
    ...
    def testContainerAcceptedUnknownTokenResponse(self):
        """test WMS container-accepted API unknown token response for receiving an container-accepted
    ...
    def testContainerAcceptedUnknownTokenDatabase(self):
        """test WMS container-accepted API unknown token database update for receiving an container-accepted
    ...
    def testPrintRequestSuccessResponse(self):
        """test WMS print-request API success response for receiving an print-request
    ...
    def testPrintRequestSuccessDatabase(self):
        """test WMS print-request API success database update for receiving an print-request
    ...
    def testPrintRequestUnknownTokenResponse(self):
        """test WMS print-request API unknown token response for receiving an print-request
    ...
    def testPrintRequestUnknownTokenDatabase(self):
        """test WMS print-request API unknown token database update for receiving an print-request
    ...
    def testContainerValidationSuccessResponse(self):
        """test WMS container-validation API success response for receiving an container-validation

        API should return acceptance message
        """
        return

    @vcr.use_cassette('cassettes/container-validation-success-database.yml')
    def testContainerValidationSuccessDatabase(self):
        """test WMS container-validation API success database update for receiving an container-validation
    ...
    @vcr.use_cassette('cassettes/container-validation-success-proxy-response.yml')
    ...
    @vcr.use_cassette('cassettes/container-validation-success-proxy-database.yml')
    ...
    def testContainerValidationUnknownTokenResponse(self):
        """test WMS container-validation API unknown token response for receiving an container-validation
    ...
    def testContainerValidationUnknownTokenDatabase(self):
        """test WMS container-validation API unknown token database update for receiving an container-validation
    ...
    def testContainerInductedSuccessResponse(self):
        """test WMS container-inducted API success response for receiving an container-inducted
    ...
    def testContainerInductedSuccessDatabase(self):
        """test WMS container-inducted API success database update for receiving an container-inducted
    ...
    @vcr.use_cassette('cassettes/container-inducted-success-proxy-response.yml')
    ...
    @vcr.use_cassette('cassettes/container-inducted-success-proxy-database.yml')
    ...
    def testContainerInductedUnknownTokenResponse(self):
        """test WMS container-inducted API unknown token response for receiving an container-inducted
    ...
    def testContainerInductedUnknownTokenDatabase(self):
        """test WMS container-inducted API unknown token database update for receiving an container-inducted
    ...
    def testPickTaskPickedSuccessResponse(self):
        """test WMS pick-task-picked API success response for receiving an pick-task-picked
    ...
    def testPickTaskPickedSuccessDatabase(self):
        """test WMS pick-task-picked API success database update for receiving an pick-task-picked
    ...
    def testPickTaskPickedUnknownTokenResponse(self):
        """test WMS pick-task-picked API unknown token response for receiving an pick-task-picked
    ...
    def testPickTaskPickedUnknownTokenDatabase(self):
        """test WMS pick-task-picked API unknown token database update for receiving an pick-task-picked

        API should not update Message and MessageTransmission tables
        """
        return

    @vcr.use_cassette('cassettes/container-picked-complete-success-response.yml')
    def testContainerPickedCompleteSuccessResponse(self):
        """test WMS container-picked-complete API success response for receiving an container-picked-complete

        API should return acceptance message
        """
        return

    @vcr.use_cassette('cassettes/container-picked-complete-success-database.yml')
    def testContainerPickedCompleteSuccessDatabase(self):
        """test WMS container-picked-complete API success database update for receiving an container-picked-complete

        API should update Message and MessageTransmission tables with 
        container-picked-complete and container-picked-complete response records
        """
        return

    @vcr.use_cassette('cassettes/container-picked-complete-success-proxy-response.yml')
    ...
    @vcr.use_cassette('cassettes/container-picked-complete-success-proxy-database.yml')
    ...
    def testContainerPickedCompleteUnknownTokenResponse(self):
        """test WMS container-picked-complete API unknown token response for receiving an container-picked-complete
    ...
    def testContainerPickedCompleteUnknownTokenDatabase(self):
        """test WMS container-picked-complete API unknown token database update for receiving an container-picked-complete
    ...
    def testContainerTakenOffSuccessResponse(self):
        """test WMS container-taken-off API success response for receiving an container-taken-off
    ...
    def testContainerTakenOffSuccessDatabase(self):
        """test WMS container-taken-off API success database update for receiving an container-taken-off
    ...
    @vcr.use_cassette('cassettes/container-taken-off-success-proxy-response.yml')
    ...
    @vcr.use_cassette('cassettes/container-taken-off-success-proxy-database.yml')
    ...
    def testContainerTakenOffUnknownTokenResponse(self):
        """test WMS container-taken-off API unknown token response for receiving an container-taken-off
    ...
    def testContainerTakenOffUnknownTokenDatabase(self):
        """test WMS container-taken-off API unknown token database update for receiving an container-taken-off
