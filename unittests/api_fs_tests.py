...
class ApiFsTests(sixDKTests):
    ...
    def testPickWavesSuccessDatabase(self):
        """test FS pick-waves API success database update for
        receiving a pick-wave
    ...
    def testPickWavesMissingTokenResponse(self):
        """test FS pick-waves API missing token response for
        receiving a pick-wave
    ...
    def testPickWavesMissingTokenDatabase(self):
        """test FS pick-waves API missing token database update for
        receiving a pick-wave
    ...
    def testPickWavesIncorrectTokenResponse(self):
        """test FS pick-waves API incorrect token response for
        receiving a pick-wave
    ...
    def testPickWavesIncorrectTokenDatabase(self):
        """test FS pick-waves API incorrect token database update for
        receiving a pick-wave
    ...
    def testExceptionPickWavesSuccessResponse(self):
        """test FS exception pick-waves API success response for
        receiving a pick-wave
    ...
    def testExceptionPickWavesSuccessDatabase(self):
        """test FS exception pick-waves API success database update for
        receiving a pick-wave
    ...
    def testGroupUpdatesSuccessResponse(self):
        """test FS group-updates API success response for
        receiving a group-update
    ...
    def testGroupUpdatesSuccessDatabase(self):
        """test FS group-updates API success database update for
        receiving a group-update
    ...
    def testGroupUpdatesMissingTokenResponse(self):
        """test FS group-updates API missing token response for
        receiving a group-update
    ...
    def testGroupUpdatesMissingTokenDatabase(self):
        """test FS group-updates API missing token database update for
        receiving a group-update
    ...
    def testGroupUpdatesIncorrectTokenResponse(self):
        """test FS group-updates API incorrect token response for
        receiving a group-update
    ...
    def testGroupUpdatesIncorrectTokenDatabase(self):
        """test FS group-updates API incorrect token database update for
        receiving a group-update
    ...
    def testGroupCancelsSuccessResponse(self):
        """test FS group-cancels API success response for
        receiving a group-cancel
    ...
    def testGroupCancelsSuccessDatabase(self):
        """test FS group-cancels API success database update for
        receiving a group-cancel
    ...
    def testGroupCancelsMissingTokenResponse(self):
        """test FS group-cancels API missing token response for
        receiving a group-cancel
    ...
    def testGroupCancelsMissingTokenDatabase(self):
        """test FS group-cancels API missing token database update for
        receiving a group-cancel
    ...
    def testGroupCancelsIncorrectTokenResponse(self):
        """test FS group-cancels API incorrect token response for
        receiving a group-cancel
    ...
    def testGroupCancelsIncorrectTokenDatabase(self):
        """test FS group-cancels API incorrect token database update for
        receiving a group-cancel
