...
Revision ID: bff38d7a29fe
Revises: 
Create Date: 2019-01-04 15:16:36.328841
...
def upgrade():
    ...
    op.create_index(op.f('ix_safe_map_id'), 'safe_map', ['id'], unique=True)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_safe_map_id'), table_name='safe_map')
    op.drop_table('safe_map')
